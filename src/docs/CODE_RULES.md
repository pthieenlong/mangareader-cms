...
- End-users only purchase full books; chapters are never sold separately in the CMS.
- Admin cannot create or edit books/chapters anymore; they only review statistics and inspect book details.
